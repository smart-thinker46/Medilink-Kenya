...
export default function PharmacyVideoCallScreen() {
  ...
  const historyQuery = useQuery({
    queryKey: ["video-call-history", "pharmacy"],
    queryFn: () => apiClient.getVideoCallHistory(),
  });
  const paymentQuery = useQuery({
    queryKey: ["video-call-payments", "pharmacy"],
    queryFn: () =>
      ...
      >
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            >
              Start calls from Orders or Chat.
            </Text>
          </View>
          {!isPremium && (
            <Text
