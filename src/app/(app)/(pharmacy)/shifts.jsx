        ...
        <View style={{ paddingHorizontal: 24, marginBottom: 16 }}>
          ...
          >
            <TextInput
              ...
              placeholder="Search by job, location, specialization, or price"
          ...
          renderItem={({ item, index }) => {
            ...
            >
              ...
              >
                ...
                >
                  {isExpanded ? "Tap job title to collapse" : "Tap job title to view details"}
                </Text>
                {isExpanded && (
                  <>
                <Text
                ...
                >
                  {item.description || details.requirements || item.requirementsText || "Pending details"}
                </Text>
                <Text
                  style={{
                    fontSize: 12,
