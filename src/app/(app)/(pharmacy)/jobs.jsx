...
export default function PharmacyJobsScreen() {
  ...
  const jobsQuery = useQuery({
    queryKey: ["jobs", "pharmacy", searchQuery, statusFilter, locationFilter, specializationFilter],
    queryFn: () =>
      apiClient.getJobs({
        mine: true,
  ...
  const handleCreateJob = () => {
    if (!isProfileComplete) {
      Alert.alert(
        ...
        "Please complete at least 99% of your pharmacy profile before posting jobs.",
        [
    ...
    router.push("/(app)/(pharmacy)/job-create");
  };

  const handleEditJob = (job) => {
    router.push({
      pathname: "/(app)/(pharmacy)/job-create",
      params: { jobId: job.id },
    });
  };
      ...
      >
        ...
        <View style={{ paddingHorizontal: 24, marginBottom: 16 }}>
          ...
          {showFilters && (
            ...
            >
              <Text style={{ fontSize: 12, color: theme.textSecondary, marginBottom: 8 }}>Status</Text>
              <View style={{ backgroundColor: theme.surface, borderRadius: 10, marginBottom: 12 }}>
                <Picker
                ...
                >
                  ...
                  {["OPEN", "CLOSED", "FILLED", "CANCELLED"].map((option) => (
                    <Picker.Item key={option} label={option} value={option} />
                  ))}
                </Picker>
              </View>

              <Text style={{ fontSize: 12, color: theme.textSecondary, marginBottom: 8 }}>Location</Text>
              <View style={{ backgroundColor: theme.surface, borderRadius: 10, marginBottom: 12 }}>
                <Picker
              ...
              <Text style={{ fontSize: 12, color: theme.textSecondary, marginBottom: 8 }}>Specialization</Text>
              <View style={{ backgroundColor: theme.surface, borderRadius: 10 }}>
                <Picker
                ...
                >
                  ...
                  <View style={{ flexDirection: "row", alignItems: "center", marginTop: 10 }}>
                    ...
                    <Text style={{ fontSize: 12, color: theme.textSecondary, marginLeft: 6 }}>
                      {item.employerName || item.pharmacyName || "Employer"}
                    </Text>
